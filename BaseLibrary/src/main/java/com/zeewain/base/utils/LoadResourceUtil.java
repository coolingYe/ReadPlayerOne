...
public class LoadResourceUtil {
    ...
    private static final String RESOURCE_TYPE_MIPMAP = "mipmap";// 图片
    ...
    public Drawable getMipmapDrawable(String fieldName) {
        Drawable drawable = null;
        int resourceID = getResourceID(mResourceLoadBean.getPackageName(), RESOURCE_TYPE_MIPMAP, fieldName);
        if (mResourceLoadBean != null) {
            drawable = mResourceLoadBean.getResources().getDrawable(resourceID);
        }
        return drawable;
