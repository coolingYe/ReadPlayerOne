...
public class ClassicBannerAdapter extends BannerAdapter<ArticleInfoResp, ClassicBannerAdapter.BannerViewHolder> {
    private boolean showTitleSummary;

    public ClassicBannerAdapter(List<ArticleInfoResp> dataList) {
        super(dataList);
    }
    ...
    static class BannerViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View v) {
            if(v.getTag() != null){
                ...
                bundle.putSerializable(BaseConstants.EXTRA_ARTICLE_INFO, data);
